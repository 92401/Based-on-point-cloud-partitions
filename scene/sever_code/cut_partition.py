...
if __name__ == '__main__':
    path = "/data/shenjw/mill-19/resident/model/split_result/visible/00//partition_00.pkl"
    model_path = '/home/shenjw/3DGS/gaussian-splatting-main/partition_00/point_cloud/iteration_30000/'
    # 检查文件是否存在
...
# from shapely.vectorized import contains
# from scene.gaussian_model import GaussianModel
# from scene.vastgs.shen_partition_densify import partition
# def load_ply(path):
#     """
#     从点云文件加载点和相关属性
#     """
...
# if __name__ == '__main__':
#     # 主路径
#     base_path = "/data/shenjw/mill-19/resident/model/split_result/visible/"
